 ...
 */
public class Load0 extends AsyncTask<String, Void, JSONArray> {
    String m;public FraAnwer2 an=null;
    Context ctx;
    public Load0(Context ct, FraAnwer2 asyncResponse) {
...
boolean Check ()
{
    ...
    protected void onPostExecute(JSONArray result) {
        an.FraEdit2(result);//Log.d("m__", result);
